  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#E7F2F7]">
      <Container className="flex flex-col items-center justify-center w-full">
        <Card className="w-full md:w-5/12 max-w-2xl p-8 md:p-10 rounded-3xl shadow-2xl border border-[#D1E1F7] bg-[#ffffff] backdrop-blur-lg mt-12">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <Link
                ...
                className="text-[#297194] underline hover:text-[#1e5870] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
