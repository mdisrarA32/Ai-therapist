                    ...
                    >
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 space-y-2 overflow-hidden min-h-[2rem]">
                          ...
                          <div className="prose prose-sm dark:prose-invert leading-relaxed relative">
                            <ReactMarkdown>{msg.content}</ReactMarkdown>
                            {(msg as any).isStreaming && (
                              <span className="ml-1 inline-block w-1.5 h-4 bg-primary rounded-sm animate-pulse align-middle" />
                            )}
                          </div>
                          {msg.metadata?.goal && (
